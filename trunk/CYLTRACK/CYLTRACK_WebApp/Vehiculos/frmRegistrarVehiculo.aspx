            ...
            <asp:ValidationSummary ID="ConsultarPropietarioValidationSummary" runat="server" CssClass="failureNotification" 
                ...
                <fieldset class="login">
                    ...
                    <asp:TextBox ID="txtPlaca1" runat="server" CssClass="textEntry" Width="100px" 
                        ontextchanged="txtPlaca1_TextChanged"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RegistroVehiculoRequired" runat="server" 
                     ...
                     ValidationGroup="RegistroVehiculoValidationGroup"> * </asp:RequiredFieldValidator>
                ...
                <div id = "DivPropietario" runat ="server" visible ="false">
                 ...
                 <div id = "DatosConductor" runat ="server" visible ="false">
                    ...
                    <asp:TextBox ID="txtNombreCond" runat="server" CssClass= "textEntry" Width="160px" Enabled ="false" text="Hector"></asp:TextBox>                                       
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtPrimerApellidoCond" runat="server" CssClass= "textEntry" Width="160px" Enabled ="false" text="Garzón"></asp:TextBox>                                       
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtSegundoApellidoCond" runat="server" CssClass= "textEntry" Width="160px" Enabled ="false" text="Alarcón"></asp:TextBox>                                       
                    </div> 
                    </div> 
