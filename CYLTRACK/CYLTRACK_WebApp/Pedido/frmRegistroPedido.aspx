...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
                ...
                <br />
                   ...
                   <p>
                       <asp:Label ID="lblPlaca" runat="server" Text="Placa Vehículo: "></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="lstPlacas" runat="server">
                        </asp:DropDownList>
                        </p>
                    <p>
    ...
    &nbsp;&nbsp;&nbsp;
    <asp:DropDownList ID="lstTamanos" runat="server" AutoPostBack="true"
                            onselectedindexchanged="lstTamanos_SelectedIndexChanged">
    </asp:DropDownList>
    &nbsp;&nbsp;&nbsp;
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCantidad" 
     CssClass="failureNotification" ErrorMessage="la cantidad de cilindros del pedido es obligatoria." ToolTip="la cantidad de cilindros del pedido es obligatoria" 
      ValidationGroup="RegistrarCantidad" >*</asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCantidad" 
           CssClass="failureNotification" ErrorMessage="El campo debe contener solo datos numéricos con un máximo de 100 cilindros solicitados" 
            ValidationExpression="^([\d]{0,3})$"  
             ValidationGroup="RegistrarCantidad" >*</asp:RegularExpressionValidator>
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnEjecutar" runat="server" Text="Agregar" OnClick="btnEjecutar_Click" ValidationGroup="RegistrarCantidad"/>
    ...
    <asp:GridView ID="grvPrueba" runat="server" AutoGenerateDeleteButton="True" 
        AutoGenerateEditButton="True" onrowdeleting="grvPrueba_RowDeleting" AutoGenerateColumns="False" 
        ...
        <AlternatingRowStyle BackColor="White" />
                   ...
                   <br />
                    <asp:Label ID="lblObservaciones" runat="server" Text="Observaciones:"></asp:Label>
                        ...
                        <br />  
                          <asp:TextBox ID="txtObservaciones" runat="server" Height="65px" Width="289px" CssClass="textEntry" TextMode="MultiLine" ></asp:TextBox>
                      <br />
                     </p>
                   </div>
